...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var iu;!function(t){t.COMPONENT_READY="streamlit:componentReady",t.SET_COMPONENT_VALUE="streamlit:setComponentValue",t.SET_FRAME_HEIGHT="streamlit:setFrameHeight"}(iu||(iu={}));class nu{}function su(t){let e,r,i,n;const s=[ou,au],a=[];function o(t,e){return t[1]?0:1}return e=o(t),r=a[e]=s[e](t),{c(){r.c(),i=f()},m(t,r){a[e].m(t,r),l(t,i,r),n=!0},p(t,n){let c=e;e=o(t),e===c?a[e].p(t,n):(U(),C(a[c],1,1,()=>{a[c]=null}),N(),r=a[e],r?r.p(t,n):(r=a[e]=s[e](t),r.c()),V(r,1),r.m(i.parentNode,i))},i(t){n||(V(r),n=!0)},o(t){C(r),n=!1},d(t){a[e].d(t),t&&h(i)}}}function au(t){let e,r,i;var n=t[0];function s(t){return{props:{args:t[3],disabled:t[5],width:t[4]}}}return n&&(e=g(n,s(t))),{c(){e&&k(e.$$.fragment),r=f()},m(t,n){e&&R(e,t,n),l(t,r,n),i=!0},p(t,i){const a={};if(8&i&&(a.args=t[3]),32&i&&(a.disabled=t[5]),16&i&&(a.width=t[4]),n!==(n=t[0])){if(e){U();const t=e;C(t.$$.fragment,1,0,()=>{z(t,1)}),N()}n?(e=g(n,s(t)),k(e.$$.fragment),V(e.$$.fragment,1),R(e,r.parentNode,r)):e=null}else n&&e.$set(a)},i(t){i||(e&&V(e.$$.fragment,t),i=!0)},o(t){e&&C(e.$$.fragment,t),i=!1},d(t){t&&h(r),e&&z(e,t)}}}function ou(t){let r,i,n;const s=[t[3],{disabled:t[5]},{width:t[4]}];var a=t[0];function o(t){let r={};for(let t=0;t<s.length;t+=1)r=e(r,s[t]);return{props:r}}return a&&(r=g(a,o())),{c(){r&&k(r.$$.fragment),i=f()},m(t,e){r&&R(r,t,e),l(t,i,e),n=!0},p(t,e){const n=56&e?function(t,e){const r={},i={},n={$$scope:1};let s=t.length;for(;s--;){const a=t[s],o=e[s];if(o){for(const t in a)t in o||(i[t]=1);for(const t in o)n[t]||(r[t]=o[t],n[t]=1);t[s]=o}else for(const t in a)n[t]=1}for(const t in i)t in r||(r[t]=void 0);return r}(s,[8&e&&(c=t[3],"object"==typeof c&&null!==c?c:{}),32&e&&{disabled:t[5]},16&e&&{width:t[4]}]):{};var c;if(a!==(a=t[0])){if(r){U();const t=r;C(t.$$.fragment,1,0,()=>{z(t,1)}),N()}a?(r=g(a,o()),k(r.$$.fragment),V(r.$$.fragment,1),R(r,i.parentNode,i)):r=null}else a&&r.$set(n)},i(t){n||(r&&V(r.$$.fragment,t),n=!0)},o(t){r&&C(r.$$.fragment,t),n=!1},d(t){t&&h(i),r&&z(r,t)}}}function cu(t){let e,r,i,n;D(t[6]);let s=t[2]&&su(t);return{c(){s&&s.c(),e=f()},m(a,o){s&&s.m(a,o),l(a,e,o),r=!0,i||(n=p(window,"resize",t[6]),i=!0)},p(t,[r]){t[2]?s?(s.p(t,r),4&r&&V(s,1)):(s=su(t),s.c(),V(s,1),s.m(e.parentNode,e)):s&&(U(),C(s,1,1,()=>{s=null}),N())},i(t){r||(V(s),r=!0)},o(t){C(s),r=!1},d(t){s&&s.d(t),t&&h(e),i=!1,n()}}}function uu(t,e,r){let i,n,s,a,{component:o}=e,{spreadArgs:c=!0}=e;const u=t=>{r(2,i=t.detail),r(3,n=i.args),r(5,a=i.disabled)};var l;return v(()=>{nu.events.addEventListener(nu.RENDER_EVENT,u),nu.setComponentReady()}),l=()=>{nu.events.removeEventListener(nu.RENDER_EVENT,u)},m().$$.on_destroy.push(l),t.$$set=t=>{"component"in t&&r(0,o=t.component),"spreadArgs"in t&&r(1,c=t.spreadArgs)},[o,c,i,n,s,a,function(){r(4,s=window.innerWidth)}]}nu.API_VERSION=1,nu.RENDER_EVENT="streamlit:render",nu.events=new st,nu.registeredMessageListener=!1,nu.setComponentReady=()=>{nu.registeredMessageListener||(window.addEventListener("message",nu.onMessageEvent),nu.registeredMessageListener=!0),nu.sendBackMsg(iu.COMPONENT_READY,{apiVersion:nu.API_VERSION})},nu.setFrameHeight=t=>{void 0===t&&(t=document.body.scrollHeight),t!==nu.lastFrameHeight&&(nu.lastFrameHeight=t,nu.sendBackMsg(iu.SET_FRAME_HEIGHT,{height:t}))},nu.setComponentValue=t=>{nu.sendBackMsg(iu.SET_COMPONENT_VALUE,{value:t})},nu.onMessageEvent=t=>{switch(t.data.type){case nu.RENDER_EVENT:nu.onRenderMessage(t.data)}},nu.onRenderMessage=t=>{let e=t.args;null==e&&(console.error("Got null args in onRenderMessage. This should never happen"),e={});const r=t.dfs&&t.dfs.length>0?nu.argsDataframeToObject(t.dfs):{};e={...e,...r};const i={disabled:Boolean(t.disabled),args:e},n=new CustomEvent(nu.RENDER_EVENT,{detail:i});nu.events.dispatchEvent(n)},nu.argsDataframeToObject=t=>{const e=t.map(({key:t,value:e})=>[t,nu.toArrowTable(e)]);return Object.fromEntries(e)},nu.toArrowTable=t=>{const{data:e,index:r,columns:i}=t.data;return new ru(e,r,i)},nu.sendBackMsg=(t,e)=>{window.parent.postMessage({isStreamlitMessage:!0,type:t,...e},"*")};const lu=()=>{var t;v(()=>{nu.setFrameHeight()}),t=()=>{nu.setFrameHeight()},m().$$.after_update.push(t)};function hu(t,e,r){const i=t.slice();return i[4]=e[r],i}function du(t){let e,r,i,n,s;return{c(){e=d("img"),u(e.src,r=t[4])||y(e,"src",r),y(e,"id",i=t[4]),y(e,"alt",""),b(e,"height",t[1]+"px"),y(e,"class","svelte-1q3l3t1")},m(r,i){l(r,e,i),n||(s=p(e,"click",t[2]),n=!0)},p(t,n){1&n&&!u(e.src,r=t[4])&&y(e,"src",r),1&n&&i!==(i=t[4])&&y(e,"id",i),2&n&&b(e,"height",t[1]+"px")},d(t){t&&h(e),n=!1,s()}}}function fu(e){let r,i=e[0],n=[];for(let t=0;t<i.length;t+=1)n[t]=du(hu(e,i,t));return{c(){r=d("div");for(let t=0;t<n.length;t+=1)n[t].c();y(r,"class","scroller svelte-1q3l3t1")},m(t,e){l(t,r,e);for(let t=0;t<n.length;t+=1)n[t].m(r,null)},p(t,[e]){if(7&e){let s;for(i=t[0],s=0;s<i.length;s+=1){const a=hu(t,i,s);n[s]?n[s].p(a,e):(n[s]=du(a),n[s].c(),n[s].m(r,null))}for(;s<n.length;s+=1)n[s].d(1);n.length=i.length}},i:t,o:t,d(t){t&&h(r),function(t,e){for(let r=0;r<t.length;r+=1)t[r]&&t[r].d(e)}(n,t)}}}function pu(t,e,r){lu();let i,{imageUrls:n}=e,{height:s}=e;return t.$$set=t=>{"imageUrls"in t&&r(0,n=t.imageUrls),"height"in t&&r(1,s=t.height)},[n,s,function(t){i=t.srcElement.currentSrc,nu.setComponentValue(i)}]}class yu extends ${constructor(t){super(),P(this,t,pu,fu,a,{imageUrls:0,height:1})}}return new class extends ${constructor(t){super(),P(this,t,uu,cu,a,{component:0,spreadArgs:1})}}({target:document.body,props:{component:yu,spreadArgs:!0}}),yu}();
